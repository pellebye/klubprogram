...
public class CreateThreadRunnableExample implements Runnable {
	...
	/*
	 * A class must implement run method to implement Runnable interface. Signature
	 * of the run method is,
	 * 
	 * public void run()
	 * 
	 * Code written inside run method will constite a new thread. New thread will
	 * end when run method returns.
	 */
	public void run() {
 ...
 * 
 * Main thread : 0 Child Thread : 0 Child Thread : 1 Main thread : 1 Main thread
 * : 2 Child Thread : 2 Child Thread : 3 Main thread : 3 Main thread : 4 Child
 * Thread : 4 Child thread finished! Main thread finished!
 * 
 */